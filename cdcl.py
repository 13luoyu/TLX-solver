...
def cdcl_based_solver(cnf:cnf_realisation.Cnf, var_values:VarValues, impl_graph:Graph):
    ...
    while not var_values.are_all_assigned():
        ...
        was_conflict = unit_propagation_conflict(cnf, var_values, impl_graph, level)
        if was_conflict:
